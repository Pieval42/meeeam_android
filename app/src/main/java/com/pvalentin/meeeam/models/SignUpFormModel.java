...
public class SignUpFormModel {
    ...
    public SignUpFormModel(String pseudo, String password, String firstName,
    ...
    public String getNAME_REGEX() {
        return "^[A-ZÁÀÂÄÃÅÇÉÈÊËÍÌÎÏÑÓÒÔÖÕÚÙÛÜÝŸÆŒa-záàâäãåçéèêëíìîïñóòôöõúùûüýÿæœ'\\-\\s]{1,50}$";
    }
    ...
    public String getPOSTCODE_REGEX() {
        return "^[a-zA-Z0-9\\-]{2,10}$";
    }

    public String getCITY_REGEX() {
        return "^[A-ZÁÀÂÄÃÅÇÉÈÊËÍÌÎÏÑÓÒÔÖÕÚÙÛÜÝŸÆŒa-záàâäãåçéèêëíìîïñóòôöõúùûüýÿæœ'\\-\\s]{1,50}$";
    }
}
